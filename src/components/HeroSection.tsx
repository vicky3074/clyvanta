        ...
        <div className="space-y-8">
          ...
          <div className="flex flex-col sm:flex-row gap-4">
            <Link
              ...
              className="bg-gradient-to-r from-clyvanta-blue-light to-clyvanta-blue-dark text-white px-3 sm:px-6 py-3 sm:py-4 rounded-full font-semibold text-sm sm:text-base lg:text-lg shadow-[0_10px_40px_rgba(0,212,255,0.3)] hover:shadow-[0_10px_50px_rgba(0,212,255,0.4)] transform hover:-translate-y-1 transition-all duration-300 inline-block text-center max-w-full"
            >
