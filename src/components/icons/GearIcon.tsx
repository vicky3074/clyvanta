...
export default function GearIcon({ className = "", size = 24 }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
    ...
    >
      <path
        d="M12 15.5A3.5 3.5 0 0 1 8.5 12A3.5 3.5 0 0 1 12 8.5A3.5 3.5 0 0 1 15.5 12A3.5 3.5 0 0 1 12 15.5Z"
        fill="currentColor"
      />
      <path
